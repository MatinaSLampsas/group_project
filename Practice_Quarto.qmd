...
Below we have created a visualization to show the relationship between the average life expectancy of humans across the world and consumption-based C02 emissions per capita over the years of 2000-2022. Our response variable (y) is life expectancy (in years) and our explanatory variable (x) is year (2000-2022). It is evident that carbon emissions increase over time as well as the average life expectancy. So, despite the higher amounts of carbon emissions in the atmosphere across the world, life expectancy has increased since 2000.
...
Below we have created another visualization to show the relationship between the average life expectancy of humans and consumption-based C02 emissions per capita in the top 10 countries with the highest C02 emissions.

\*\*still need to finish this part once the graph is there!
