...
Using the values from the regression model, the table is constructed below with the following data:

-   `var_y` represents the variance in the response values.
-   `var_y_hat` represents the variance in the fitted values.
-   `var_residual` represents the variance in the residuals.
-   `r_squared`represents the proportion of the spread/variation of the outcome variable `avg_life` explained by the model.
